...
(1, 'Desa sukamaju', 'Kecamatan sabi, provinsi jawa barat', '2018-11-30 17:00:00', '', 12),
(2, 'Desa gasuka mundur', 'Kecamatan bisa, provinsi jawa barat', '2018-12-01 18:00:00', '', 13);
...
INSERT INTO `peserta` (`id_sayembara`, `id_user`, `subtopik`, `tgl_kirim`, `file_proposal`) VALUES
(1, 9, 'asdf', '2018-12-09 07:20:21', 'zz');
...
CREATE TABLE `sayembara` (
  ...
  `foto_sayembara` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 'walidesa1', 'walidesa1', 'walidesa1@gmail.com', 'Wali desa satu', 1, 0),
(4, 'walidesa2', 'walidesa2', 'walidesa2@gmail.com', 'Wali desa dua', 1, 0),
...
(9, 'userbiasa3', '$2a$10$q5PNJ4ufwJWFy9KuD0DdiOYho6ka3sQx8yn.85XV.TEh3wvezhkui', 'userbiasa3@gmail.com', 'User biasa tiga', 2, NULL),
(10, 'adminbaru', '$2a$10$hgEityHezlg39tynAdlTVeZtzxR2BvVabNIFIhLhJuRufuV/jVqpm', 'adminbaru@gmail.com', 'admin baru', 0, NULL),
(11, 'kreatorbaru', '$2a$10$Ct6XHCzuT901errc83KKH.E6AHHDxvVtUOlH4PuuhVxvEkFm4992O', 'kreatorbaru@gmail.com', 'kreatorbaru', 3, NULL),
(12, 'walibaru', '$2a$10$FPehBqOzYlc.K7.gKGRDgO/AGOnKsT1h3OG0LDdmg6K7xa.rXmP8W', 'walibaru@gmail.com', 'walibaru', 1, 1),
(13, 'waliaja', '$2a$10$uNNEen.PlAdmOgxgodwbMu8d5VZvTcwIik29qf22/1UzuMkgL55vW', 'waliaja@gmail.com', 'waliaja', 1, 2);
