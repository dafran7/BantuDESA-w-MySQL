...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2018 at 01:45 PM
...
INSERT INTO `sayembara` (`id_sayembara`, `id_desa`, `judul_sayembara`, `topik`, `deskripsi_singkat`, `isi_sayembara`, `foto_sayembara`) VALUES
(1, 1, 'Sanitasi sungai ciliwung', 'Sanitasi perairan', 'Butuh ide untuk sanitasi sungai ciliwung', 'Dibutuhkan ide untuk menciptakan sungai ciliwung yang bersih dan jernih', ''),
(2, 2, 'Pemanfaatan danau abot', 'Pemanfaatan danau', 'Butuh ide untuk memanfaatkan danau abot', 'Danau abot yang indah dan luas belum dimanfaatkan nih. Saya butuh ide kira-kira diapakan ya?', '');
...
--
ALTER TABLE `sayembara`
  MODIFY `id_sayembara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
